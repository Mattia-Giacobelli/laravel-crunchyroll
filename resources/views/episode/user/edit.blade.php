...
@section('main')
    <div class="container mt-5">
        ...
        <form action="{{ route('user.episode.update', $episode) }}" method="POST" enctype="multipart/form-data"
            data-bs-theme="dark">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="number" name="number" value="{{ $episode->number }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="duration" name="duration" value="{{ $episode->duration }}"
                    min="20" max="1000">
            </div>
