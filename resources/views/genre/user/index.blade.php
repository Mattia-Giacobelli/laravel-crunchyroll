...
@section('main')
    <div class="container  mt-5">
        ...
        <div class="d-flex justify-content-end">
            <a class="btn btn-primary" href="{{ route('user.genre.create') }}">Aggiungi un genere</a>
        </div>
                ...
                @foreach ($genres as $genre)
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <a href="{{ route('user.genre.show', $genre['id']) }}">{{ $genre['name'] }}</a>
                        </td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content text-light bg-dark">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModal{{ $genre['id'] }}Label">
                                        {{ $genre->name }}</h1>
