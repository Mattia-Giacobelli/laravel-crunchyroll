...
@section('main')
    <div class="container  mt-5">
        ...
        <div class="d-flex justify-content-end">
            <a class="btn btn-primary" href="{{ route('user.type.create') }}">Aggiungi una Tipologia</a>
        </div>
                ...
                @foreach ($types as $type)
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <a href="{{ route('user.type.show', $type['id']) }}">{{ $type['name'] }}</a>
                        </td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content text-light bg-dark">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModal{{ $type['id'] }}Label">
                                        {{ $type->name }}</h1>
