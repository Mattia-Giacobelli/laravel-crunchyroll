...
@section('main')
    <div class="container mt-5">
        ...
        <form action="{{ route('user.anime.store') }}" method="POST" enctype="multipart/form-data" data-bs-theme="dark">
            ...
            @foreach ($genres as $genre)
                <div class="form-check form-check-inline mb-3">
                    <input name="genres[]" value="{{ $genre->id }}" class="form-check-input" type="checkbox"
                        id="genre{{ $genre->id }}">
            ...
            @foreach ($dubs as $dub)
                <div class="form-check form-check-inline mb-3">
                    <input name="dubs[]" value="{{ $dub->id }}" class="form-check-input" type="checkbox"
                        id="dub{{ $dub->id }}">
            ...
            @foreach ($subs as $sub)
                <div class="form-check form-check-inline mb-3">
                    <input name="subs[]" value="{{ $sub->id }}" class="form-check-input" type="checkbox"
                        id="sub{{ $sub->id }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="episodes_duration" name="episodes_duration" min="1"
                    max="1000">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="release_date" name="release_date" min="1970-01-01"
                    max="{{ date('Y-m-d') }}">
            </div>

            <div class="mb-3">
                <label for="end_date" class="form-label">Data di conclusione</label>
                <input type="date" class="form-control" id="end_date" name="end_date" min="1970-01-01"
                    max="{{ date('Y-m-d') }}">
            </div>
