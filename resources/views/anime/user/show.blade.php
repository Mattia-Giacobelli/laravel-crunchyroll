...
@section('main')
    <div class="container mt-4">
        ...
        <div class="buttons">
            <a class="back" href="{{ url('user/anime') }}">
                <i class="bi bi-arrow-left"></i>
            </a>

            <div>
                <a class="btn btn-outline-warning " href="{{ route('user.anime.edit', $anime) }}">Modifica</a>

                <!-- Button trigger modal -->
                <button type="button" class="btn btn-outline-danger " data-bs-toggle="modal"
                    data-bs-target="#exampleModal{{ $anime['id'] }}">
                    Elimina
                </button>
            </div>
        </div>
        ...
        <div class="mt-5">
            <div class="d-flex justify-content-end">
                <a class="btn btn-primary" href="{{ route('user.anime.episode.create', $anime) }}">Aggiungi un episodio</a>
            </div>
                    ...
                    @foreach ($anime->episodesList as $episode)
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <a href="{{ route('user.episode.show', $episode['id']) }}">
                                    <img src="{{ asset('storage/' . $episode->cover) }}" alt="copertina episodio"
                                        width="50px">
                                </a>
                            </td>

                            <td class="align-middle"><a
                                    href="{{ route('user.episode.show', $episode['id']) }}">{{ $episode['title'] }}</a>
                            </td>
                            ...
                            <td>
                                <a class="btn btn-outline-warning "
                                    href="{{ route('user.episode.edit', $episode) }}">Modifica</a>
                            </td>

                            <td>
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-outline-danger " data-bs-toggle="modal"
                                    data-bs-target="#exampleModal{{ $episode['id'] }}">
                                    Elimina
                                </button>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModal{{ $episode['id'] }}" tabindex="-1"
                            aria-labelledby="exampleModal{{ $episode['id'] }}Label" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content text-light bg-dark">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="exampleModal{{ $episode['id'] }}Label">
                                            {{ $episode->name }}</h1>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="{{ route('user.episode.destroy', $episode) }}" method="POST">
    ...
    <!-- Modal -->
    <div class="modal fade" id="exampleModal{{ $anime['id'] }}" tabindex="-1"
        aria-labelledby="exampleModal{{ $anime['id'] }}Label" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content text-light bg-dark">
                <div class="modal-header">
