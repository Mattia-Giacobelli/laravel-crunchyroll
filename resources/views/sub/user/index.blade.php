...
@section('main')
    <div class="container  mt-5">
        ...
        <div class="d-flex justify-content-end">
            <a class="btn btn-primary" href="{{ route('user.sub.create') }}">Aggiungi una Lingua sottotitoli</a>
        </div>
                ...
                @foreach ($subs as $sub)
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <a href="{{ route('user.sub.show', $sub['id']) }}">{{ $sub['language'] }}</a>
                        </td>
                        <td class="align-middle">
                            {{ $sub['iso_code'] }}
                        </td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content text-light bg-dark">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModal{{ $sub['id'] }}Label">
                                        {{ $sub->language }}</h1>
